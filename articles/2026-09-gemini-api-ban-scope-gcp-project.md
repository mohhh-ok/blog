---
title: "Gemini APIのBANがプロジェクトを巻き込む危険性"
emoji: "🚫"
type: "tech"
topics: ["googlecloud", "gemini", "gcp", "ai", "セキュリティ"]
published: true
---
...
![停止処分の 5 段階を入れ子で描いた図。外側から Google アカウント全体、Google Cloud アカウント、Billing アカウント、プロジェクト、API クライアント。アプリ本体プロジェクトと鍵専用プロジェクトを別 Billing に置くと 1〜3 段は切れるが、4〜5 段は所有者の Google アカウントを分けないと切れない](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/09-16-gemini-isolation-tiers.svg)
