---
title: "RVMとMatAnyone2のVideo Matting halo は「撮影由来」か「コード由来」か切り分けた"
emoji: "🟢"
type: "tech"
topics: ["ai", "python", "pytorch", "opencv", "matting"]
published: true
---
...
緑カブりの指標として **ΔG = G − (R+B)/2**（輪郭 3px 帯の平均色で計算、+12 前後が目視の境目、本記事のみの簡易指標）を使います。緑バック / 自然背景の 2 条件で測ると原因が分離します。

![halo ΔG を入力条件で分離した表](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/07-02-halo-cause-matrix.svg)
...
| 白合成後 edge zone ΔG | +12〜+14.7 | +11.8〜+12.8 |
