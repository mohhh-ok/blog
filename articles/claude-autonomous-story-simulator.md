...
emoji: "⏳"
type: "tech"
topics: ["claudecode", "llm", "bun", "個人開発"]
published: true
---

個人開発で公開運用中の「AIが自走する物語サイト」を紹介します。Claudeが2時間ごとに世界を1日進める物語シミュレータです。物語が完結するとサーバーのワーカーが自動停止し、サイトはエピローグを表示したまま永久に止まります。リセットなし、一回きりの上演として設計しました。
...
![5体の妖が暮らす京都の霊脈世界](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/06-05-ai-30-countdown-hero.webp)
...
![1tickの処理フロー。LLMは判断、エンジンは計算、不正出力はデフォルト化、上限時は巻き戻し](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/06-05-ai-30-countdown-architecture.svg)
