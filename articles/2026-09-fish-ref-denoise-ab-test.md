---
title: "TTSの参照音声にdenoiseをかけると品質は上がるのか（Fish AudioでABテスト）"
emoji: "🎙️"
type: "tech"
topics: ["tts", "fishaudio", "voiceclone", "ai", "音声"]
published: true
---
...
![参照音声の前処理条件別 NG 率の棒グラフ。N (denoiseなし) が 3/320、R (16kHzのみ) が 4/320、D (denoise+16kHz) が 21/320 で、D だけが突出して高い。エラーバーは Wilson 95% 信頼区間](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/09-13-fish-denoise-ab-by-condition.webp)
...
![参照音声の変種別 NG 率の棒グラフ。大音量クリーンは N 1/80・R 0/80・D 4/80、小音量クリーンは 2/80・3/80・5/80、大音量ノイズは 0/80・1/80・5/80、小音量ノイズは 0/80・0/80・7/80。D だけが 4 変種すべてで高く、小音量ノイズが最大](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/09-13-fish-denoise-ab-by-variant.webp)
...
- [Fish Audioのzero-shot voice cloneは毎回同じ声が出るのか](https://mohhh-ok.github.io/blog/posts/2026/08-26-aifish-audioのzero-shot-voice-cloneは毎回同じ声が出るのか話者embeddingで測定/)
- [TTS参照音声の密度で品質が決まる話](https://mohhh-ok.github.io/blog/posts/2026/08-26-aitts参照音声の密度で品質が決まる話mean_volumeとzero-shot-voice-clone/)
