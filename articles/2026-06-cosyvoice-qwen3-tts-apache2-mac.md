---
title: "Apache 2.0 な多言語 voice clone OSS を Mac で試す（Qwen3-TTS / CosyVoice 2・3）"
emoji: "🗣️"
type: "tech"
topics: ["ai", "tts", "voiceclone", "cosyvoice", "qwen"]
published: true
---
...
![7言語×4設定のCERヒートマップ](https://raw.githubusercontent.com/mohhh-ok/blog/main/src/content/posts/2026/06-22-cer-heatmap.svg)
...
前回 (2026-06-20) の記事で F5-TTS / XTTS-v2 / OpenVoice v2 / ElevenLabs を 7 言語で比較し、総合 1 位は ElevenLabs、OSS では XTTS-v2 が首位という結論でした。
...
その後最新情報を調べたところ、Alibaba 系から 3 つ Apache 2.0 の voice clone モデルが出ていたので、それを検証する形です。
...
[音声を再生 (ref.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-19-multilingual-voice-cloning-benchmark/reference/ref.wav)
...
[音声を再生 (cosyvoice2/ja.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/cosyvoice2/ja.wav)
...
[音声を再生 (cosyvoice3/ja.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/cosyvoice3/ja.wav)
...
[音声を再生 (qwen3_tts/ja.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/qwen3_tts/ja.wav)
...
[音声を再生 (cosyvoice2/zh.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/cosyvoice2/zh.wav)
...
[音声を再生 (qwen3_tts/zh.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/qwen3_tts/zh.wav)
...
[音声を再生 (cosyvoice2/de.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/cosyvoice2/de.wav)

**CosyVoice 3** (CER 0.125、概ね言えてるが accent あり):

[音声を再生 (cosyvoice3/de.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/cosyvoice3/de.wav)

**Qwen3-TTS** (CER 0.000、完璧):

[音声を再生 (qwen3_tts/de.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/qwen3_tts/de.wav)
...
[音声を再生 (elevenlabs/en.mp3)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-19-multilingual-voice-cloning-benchmark/output/elevenlabs/en.mp3)

**Qwen3-TTS:**

[音声を再生 (qwen3_tts/en.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/qwen3_tts/en.wav)

**CosyVoice 3** (こちらも声質保持寄り):

[音声を再生 (cosyvoice3/en.wav)](https://cdn.jsdelivr.net/gh/mohhh-ok/blog-examples@main/2026/06-22-tts-commercial-provider-comparison/output/cosyvoice3/en.wav)
...
以下は AI が参照したと思われるサイトです。検証しておりませんので、そのつもりでご参照いただければ幸いです。
