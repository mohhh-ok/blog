...
curlのGET系は使えるため、サーバーを立ててGETで副作用を持たせることでこれを解決できます。なおWebFetchはlocalhostに使用できないため、curlでAPIを叩かせます。

## 流れ

### セットアップ

後述するプロンプトを使用して、セットアップします。

1. プロンプト（後述）をClaude Codeに渡してサーバーを構築
...
以下のようなプロンプトでサーバーを作り、目的を達成できました。
