...
元動画と watermark 入り動画を pixel 単位で比較しました。

![元動画 / watermark入り動画 / 差分20倍拡大の3並び](./06-27-c2pa-watermark-diff.png)

差分を 20 倍に拡大すると、DCT 係数に乗ったノイズパターンが目視で確認できます。等倍だと完全に同じに見えますが (PSNR 39.54 dB)、ピクセル単位では確実に変わっている。
