---
title: "【Remotion】字幕だけ変えたいとき、全部描き直さずに済むか【3方式を実測】"
pubDate: 2026-09-21
categories: ["React"]
---
...
![同じ時刻のフレームを X、Y、Z-vp9、Z-prores の順に並べた画像。紺色のグラデーションの背景に、縁がぼけたオレンジの円が重なり、下に「今日は朝から天気が良くて、散歩に出かけました。」という字幕が出ている。「天気が」の部分だけ黄色でハイライトされている。4 枚とも、字幕の位置と大きさ、円の縁の混ざり方が一致している](./09-21-remotion-subtitle-compare.webp)
...
- [【Remotion】Compositionをバンドルして再利用する](/blog/posts/2026/01-24-remotioncompositionをバンドルして再利用する/)
